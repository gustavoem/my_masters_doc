...
\usepackage[paperheight=1.3in,paperwidth=3.6in,margin=0in]{geometry}
...
\draw [->, thick] (-1.5, 6.8) ->  (-1.6,   6.2);
\draw [->, thick] (-1.5, 6.8) ->  (0.2, 6.2);

\node  at (-6.1, 6) (XGDP) {$\bf P'ase_2$};
\draw [-|, thick] (-6, 6.2) ->  (-5, 6.7);
\draw [-|, thick] (-6, 6.2) ->  (-3.1, 6.7);

\node  at (-6.3, 6.5) (X3) {$k_5^{cat},K_5m$};
\node  at (-4.3, 6.2) (X3) {$k_6^{cat},K_6m$};


\node  at (-3.1, 6) (XGDP) {$\bf ERK$};
\draw [->, thick] (-2.7, 6.1) ->  (-1.4, 6.1);
\draw [<-, thick] (-2.7, 5.9) ->  (-1.4, 5.9);
...
\node  at (0.1, 6.7) (X3) {$k_8^{cat},K_8m$};


\node  at (-0.9, 5) (XGDP) {$\bf P'ase_3$};
\draw [-|, thick] (-0.9, 5.2) ->  (-2, 5.7);
\draw [-|, thick] (-0.9, 5.2) ->  (0.2, 5.7);

\node  at (-2.2, 5.3) (X3) {$k_9^{cat},K_9m$};
\node  at (0.3, 5.3) (X3) {$k_{10}^{cat},K_{10}m$};


%\draw [line width = 1pt,dotted,red] (1.5, 5.75) --  (1.5, 3.9);
%\draw [line width = 1pt,dotted,red] (1.5, 3.9) --  (-7.05, 3.9);
%\draw [-|, line width = 1pt,dotted,red] (-7.05, 3.9) --  (-7.05, 7.7);

%\node  at (-3, 4.15) (X3) {$k_{11}^{cat},K_{11}m$};
%\node  at (-3, 3.75) (XA) {negative feedback};
