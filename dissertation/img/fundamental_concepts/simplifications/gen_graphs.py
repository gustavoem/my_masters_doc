...
ode.overtime_plot (['S', 'P', 'E', 'ES'], np.linspace (0, 100, 1000), 
        filename='full_system', xlabel='Time (seconds)', ylabel='Concentration (mol/$\mu m^3$)', title=None)
...
ode.overtime_plot (['S', 'P'], np.linspace (0, 100, 1000), 
        filename='mm_system', xlabel='Time (seconds)', 
