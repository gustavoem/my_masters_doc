...
unsatisfactory overfitting penalization. We defined a cost function
based on the marginal likelihood of a model producing the observed
experimental data. We experiment and show how this new cost function 
...
glance of the surface induced by the cost function we define. With this
work, we expect to contribute on problem of identification of cell 
signaling pathway problem, providing a well founded cost function that
...
complexidade de modelos satisfatoriamente. Neste trabalho, definimos uma
...
o espaço de busca. Com este trabalho, esperamos contribuir para o
problema de seleção de vias de sinalização celular, fornecendo uma
função de custo bem fundada que possa ser utilizada em uma abordagem
