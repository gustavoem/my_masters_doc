...
A possible approach to analyze the produced parameter values is to simulate
...
We also created plots of approximations of the produced power posterior
...
%
% Eu mudei a imagem da função custo c de reais positivos para somente reais, 
% porque mais para frente, em seu procedimento de seleção de características
...
Therefore, seven chemical species are present in the Ras switch model,
