...
of the marginal likelihood of the correct model was $-60$, compared
to $10.8$ for the found model. To understand these numbers, we also
plotted the simulations found for the correct model. % TODO: yeah...

% show the cost of the correct model, and explain why it is not the
% optimal.

% Watch bias vs std of professor mustafa
