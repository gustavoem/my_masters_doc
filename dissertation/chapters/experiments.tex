...
\begin{itemize}
    \item{$\hat{p} (M = 1 | D, \epsilon = 1) = 0.005$;}
    \item{$\hat{p} (M = 2 | D, \epsilon = 1) = 0.014$;} 
    \item{$\hat{p} (M = 3 | D, \epsilon = 1) = 0.976$;}
    \item{$\hat{p} (M = 4 | D, \epsilon = 1) = 0.003$.}
\end{itemize}
These estimates induces the ranking 3, 2, 1, 4.

SigNetMS software, on the other hand, produced 
