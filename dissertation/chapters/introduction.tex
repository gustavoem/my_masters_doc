...
% With the title "." Lulu Wu presented in her masters dissertation a
% methodology to systematically modify a computational model for a 
% signaling network. Lulu created a database of chemical interactions
% joining information from many statical maps from KEGG; a subset of 
% those interactions were then added to the initial model in order to 
% better simulate the signaling pathway of interest. The choice of this
% subset is actually a combinatorial optimization problem. The cost 
% function %TODO: finish describing the optimization problem
