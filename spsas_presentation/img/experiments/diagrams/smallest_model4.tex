...
\node at (1.5, -1) (ABAB) {};
    ...
    \node[draw, circle] at (3, -3) (C) {$\bf C$};
    \draw [->, thick] ($(B)+(.15,0.05)$) -- ($(C)+(-.2,0.05)$);
    \draw [<-, thick] ($(B)+(.15,-0.05)$) to node[below, yshift=-1em] {$K_{4m}, V_4$} ($(C)+(-.2,-0.05)$);
