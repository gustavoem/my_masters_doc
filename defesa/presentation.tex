...
\begin{frame}
    ...
    graphics={width=\textwidth}]{experiments/simulations/bioinformatics_correct}
\end{frame}
...
\begin{frame}{The set of features of our experiment}
% show the two last, incorrect reactions
\end{frame}
...
\begin{frame}{Results of the search}
% show the diagram of the found model
\end{frame}

\begin{frame}{Results of the search}
% show simulations of the found model
\end{frame}

\begin{frame}{Results of the search}
% show simulations of the correct model
\end{frame}

\begin{frame}{Results of the search}
% marginal likelihood approaches prefer intermediate complexity 
\end{frame}
