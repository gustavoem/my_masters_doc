...
%-> Yeah, it does give the ~right ordering
%-> the last population with individuals of all models is the 10th
%-> model 3 is still on average... However, this time it looses space to
   %other models 
